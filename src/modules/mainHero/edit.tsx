...
import { Alert, Button, ColorPicker, Form, Image, Input, message, Space, Upload } from "antd";
...
function MainHeroEdit() {
    ...
    const updateHeroFun = (values: MainHeroRequest) => {
        const heroData: MainHeroRequest = {
            ...values,
            img: uploadImg ?? hero?.imgUrl ?? null,
                        ...
                        >
                            ...
                            <Form.Item label="Old image" name="img">
                                <div style={{ width: "72px", height: "72px" }}>
                                    <Image
                                        preview={false}
                                        src={import.meta.env.VITE_BE_PUBLIC + hero.imgUrl}
                                    />
                                </div>
